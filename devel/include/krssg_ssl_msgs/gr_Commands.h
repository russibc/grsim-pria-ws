...
bool operator==(const ::krssg_ssl_msgs::gr_Commands_<ContainerAllocator1> & lhs, const ::krssg_ssl_msgs::gr_Commands_<ContainerAllocator2> & rhs)
{
  return lhs.timestamp == rhs.timestamp &&
    lhs.isteamyellow == rhs.isteamyellow &&
