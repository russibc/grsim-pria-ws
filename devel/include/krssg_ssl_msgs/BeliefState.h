...
struct BeliefState_
{
  ...
  _ballVel_type ballVel;
   ...
   typedef std::vector< ::geometry_msgs::Pose2D_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::Pose2D_<ContainerAllocator> >> _awayPos_type;
  _awayPos_type awayPos;

   typedef std::vector< ::geometry_msgs::Pose2D_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::Pose2D_<ContainerAllocator> >> _homePos_type;
  _homePos_type homePos;

   typedef uint8_t _ballDetected_type;
  _ballDetected_type ballDetected;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _homeDetected_type;
  _homeDetected_type homeDetected;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _awayDetected_type;
...
bool operator==(const ::krssg_ssl_msgs::BeliefState_<ContainerAllocator1> & lhs, const ::krssg_ssl_msgs::BeliefState_<ContainerAllocator2> & rhs)
{
  return lhs.isteamyellow == rhs.isteamyellow &&
    lhs.frame_number == rhs.frame_number &&
    lhs.t_capture == rhs.t_capture &&
    lhs.t_sent == rhs.t_sent &&
    lhs.ballPos == rhs.ballPos &&
    lhs.ballVel == rhs.ballVel &&
    lhs.awayPos == rhs.awayPos &&
    lhs.homePos == rhs.homePos &&
    lhs.ballDetected == rhs.ballDetected &&
    lhs.homeDetected == rhs.homeDetected &&
    lhs.awayDetected == rhs.awayDetected &&
    lhs.our_bot_closest_to_ball == rhs.our_bot_closest_to_ball &&
    lhs.opp_bot_closest_to_ball == rhs.opp_bot_closest_to_ball &&
    lhs.our_goalie == rhs.our_goalie &&
    lhs.opp_goalie == rhs.opp_goalie &&
    lhs.opp_bot_marking_our_attacker == rhs.opp_bot_marking_our_attacker &&
    lhs.ball_at_corners == rhs.ball_at_corners &&
    lhs.ball_in_our_half == rhs.ball_in_our_half &&
    lhs.ball_in_our_possession == rhs.ball_in_our_possession;
}
