...
struct SSL_DetectionFrame_
{
  ...
  _camera_id_type camera_id;
   ...
   typedef std::vector< ::krssg_ssl_msgs::SSL_DetectionBall_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::krssg_ssl_msgs::SSL_DetectionBall_<ContainerAllocator> >> _balls_type;
  _balls_type balls;

   typedef std::vector< ::krssg_ssl_msgs::SSL_DetectionRobot_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::krssg_ssl_msgs::SSL_DetectionRobot_<ContainerAllocator> >> _robots_yellow_type;
  _robots_yellow_type robots_yellow;

   typedef std::vector< ::krssg_ssl_msgs::SSL_DetectionRobot_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::krssg_ssl_msgs::SSL_DetectionRobot_<ContainerAllocator> >> _robots_blue_type;
...
bool operator==(const ::krssg_ssl_msgs::SSL_DetectionFrame_<ContainerAllocator1> & lhs, const ::krssg_ssl_msgs::SSL_DetectionFrame_<ContainerAllocator2> & rhs)
{
