...
bool operator==(const ::krssg_ssl_msgs::gr_RobotReplacement_<ContainerAllocator1> & lhs, const ::krssg_ssl_msgs::gr_RobotReplacement_<ContainerAllocator2> & rhs)
{
  return lhs.x == rhs.x &&
    lhs.y == rhs.y &&
    lhs.dir == rhs.dir &&
    lhs.id == rhs.id &&
    lhs.yellowteam == rhs.yellowteam;
}
