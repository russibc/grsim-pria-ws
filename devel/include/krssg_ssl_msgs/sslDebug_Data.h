...
struct sslDebug_Data_
{
  ...
  _id_type id;
   ...
   typedef std::vector< ::krssg_ssl_msgs::sslDebug_Line_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::krssg_ssl_msgs::sslDebug_Line_<ContainerAllocator> >> _line_type;
  _line_type line;

   typedef std::vector< ::krssg_ssl_msgs::sslDebug_Circle_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::krssg_ssl_msgs::sslDebug_Circle_<ContainerAllocator> >> _circle_type;
  _circle_type circle;
...
bool operator==(const ::krssg_ssl_msgs::sslDebug_Data_<ContainerAllocator1> & lhs, const ::krssg_ssl_msgs::sslDebug_Data_<ContainerAllocator2> & rhs)
{
