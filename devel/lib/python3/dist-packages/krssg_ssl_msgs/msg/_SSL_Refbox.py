...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_d5I().pack(_x.packet_timestamp, _x.stage, _x.stage_time_left, _x.command, _x.command_counter, _x.command_timestamp))
      _x = self.b_name
      length = len(_x)
      ...
      _x = self
      buff.write(_get_struct_6I().pack(_x.b_score, _x.b_red_cards, _x.b_yellow_cards, _x.b_timeouts, _x.b_timeout_time, _x.b_goalie))
      _x = self.y_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6I().pack(_x.y_score, _x.y_red_cards, _x.y_yellow_cards, _x.y_timeouts, _x.y_timeout_time, _x.y_goalie))
      length = len(self.y_card_times)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.y_card_times))
      length = len(self.b_card_times)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.b_card_times))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.packet_timestamp, _x.stage, _x.stage_time_left, _x.command, _x.command_counter, _x.command_timestamp,) = _get_struct_d5I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.b_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.b_name = str[start:end]
      _x = self
      start = end
      end += 24
      (_x.b_score, _x.b_red_cards, _x.b_yellow_cards, _x.b_timeouts, _x.b_timeout_time, _x.b_goalie,) = _get_struct_6I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.y_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.y_name = str[start:end]
      _x = self
      start = end
      end += 24
      (_x.y_score, _x.y_red_cards, _x.y_yellow_cards, _x.y_timeouts, _x.y_timeout_time, _x.y_goalie,) = _get_struct_6I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.y_card_times = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.b_card_times = s.unpack(str[start:end])
      return self
