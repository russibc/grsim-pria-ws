...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_I2dI().pack(_x.frame_number, _x.t_capture, _x.t_sent, _x.camera_id))
      length = len(self.balls)
      buff.write(_struct_I.pack(length))
      for val1 in self.balls:
        _x = val1
        buff.write(_get_struct_dI5d().pack(_x.confidence, _x.area, _x.x, _x.y, _x.z, _x.pixel_x, _x.pixel_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.frame_number, _x.t_capture, _x.t_sent, _x.camera_id,) = _get_struct_I2dI().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_I2dI():
    ...
    return _struct_I2dI
_struct_dI5d = None
def _get_struct_dI5d():
    global _struct_dI5d
    if _struct_dI5d is None:
