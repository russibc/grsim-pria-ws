...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_I5f2B().pack(_x.id, _x.kickspeedx, _x.kickspeedz, _x.veltangent, _x.velnormal, _x.velangular, _x.spinner, _x.wheelsspeed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.kickspeedx, _x.kickspeedz, _x.veltangent, _x.velnormal, _x.velangular, _x.spinner, _x.wheelsspeed,) = _get_struct_I5f2B().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_I5f2B = None
def _get_struct_I5f2B():
    global _struct_I5f2B
    if _struct_I5f2B is None:
        _struct_I5f2B = struct.Struct("<I5f2B")
    return _struct_I5f2B
