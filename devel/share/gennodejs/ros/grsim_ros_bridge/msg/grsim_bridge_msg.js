...
// (in-package grsim_ros_bridge.msg)
...
class grsim_bridge_msg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new grsim_bridge_msg(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new grsim_bridge_msg(null);
...
module.exports = grsim_bridge_msg;
